...
title:      "Documentation | eris:cli | eris projects services"

---

# eris projects services

List services for a project.

## Synopsis

List services for a project. If no arguments are given, will
display the services for the currently checked out project.

```bash
eris projects services [name]
```
